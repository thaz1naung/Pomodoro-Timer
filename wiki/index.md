...
- [[source-index-html]] — DOM structure: timer ring, controls, theme switcher, task label, durations, streak, sound, bg sounds, dialog
- [[source-main-js]] — Application logic: STATE object, timer core, sound, bg sounds, streak, themes, notifications, mode toggle, event wiring
- [[source-style-css]] — All styles: CSS variables, dark/light theme, blob animation, responsive breakpoints
...
- [[timer-engine]] — Core timer: STATE, tick loop, start/pause/reset, custom durations, task label, mode transitions
- [[theme-system]] — CSS variable–driven mood themes (Focus / Chill / Deep Work) with dark/light mode toggle
- [[streak-persistence]] — localStorage-based daily streak counter with midnight reset
- [[sound-engine]] — Web Audio API chime + background sounds (Rain / White Noise / Lofi), volume control, mute toggle
